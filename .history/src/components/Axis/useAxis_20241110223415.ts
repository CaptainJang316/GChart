...
export const getAppropriateMaxValue = (maxValue: number): number => {
    ...
    if (maxValue <= 10) {
        roundedMax = Math.ceil((maxValue * 1.1) / order) * order;
    } else if (maxValue <= 100) {
        roundedMax = Math.ceil((maxValue * 1.0) / order) * order;
    } else if (maxValue <= 200) {
        roundedMax = Math.ceil((maxValue * 1.05) / order) * order;
    } else {
        roundedMax = Math.ceil((maxValue * 1.02) / order) * order;
    }
