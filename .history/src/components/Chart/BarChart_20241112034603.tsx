...
const BarChart: React.FC<Option> = ({
    ...
    return (
        ...
        <div style={{ display: 'inline-block', width: `${width}px`, height: `${height}px`}}>
            <svg width='100%' height='100%' viewBox={`0 0 ${width} ${height + 30}`} style={{ border: '1px solid #ccc', padding: `${padding}px`  onMouseMove={handleMouseMove}}}>
                {              
                    title? 
                    ...
                    {data.map((d, i) => {
                        ...
                        return (
                            ...
                            <g key={i} transform={`translate(${i * barWidth}, ${height - barHeight})`}>
                                ...
                                />
                                {isHovered? 
                                <StyledTooltip x={mousePosition.x} y={mousePosition.y}>
