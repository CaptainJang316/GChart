            ...
            <svg width='100%' height='100%' viewBox={`0 0 ${width} ${height + 30}`} style={{ border: '1px solid #ccc', padding: `${padding}px`}}>
                {               
                    ...
                    <g className='title-layer'>
                        ...
                        <StyledTitle 
                            ...
                            x={title.titleAlign == 'end'? '100%' : title.titleAlign == 'middle'? '50%' : -5}
                            y={20}
                        >
                            {title.text}
                        </StyledTitle>
                        {title.subTitle && (
                            <StyledSubTitle
                                ...
                                fill='gray'
                                x={title.titleAlign == 'start'? -5 : title.titleAlign == 'middle'? '50%' : '100%'}
                                y={47}
                ...
                <g className='axis-layer'>
                    {yAxis.ticks.map((tick) => (
                        <text
                            x={axis?.yAxis?.axisLabel?.formatter == ''? 0 : -5}
                            y={tick.position}
                            textAnchor="start"
                            fontSize="16"
                            fill="gray"
