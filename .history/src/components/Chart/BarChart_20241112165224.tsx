...
const BarChart: React.FC<Option> = ({
    ...
    const handleMouseMove = (e: React.MouseEvent<SVGRectElement, MouseEvent>, i: number | null) => {
                        ...
                        return (
                            ...
                            <g key={i} transform={`translate(${i * barWidth}, ${height - barHeight})`}>
                                <StyledRect
                                    ...
                                    onMouseOver={() => setHoveredInfo(prev => ({x: i * barWidth, y: height - barHeight, index: i}))}
