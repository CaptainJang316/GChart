        ...
        <svg width={width} height={height} style={{ border: '1px solid #ccc', padding: '2.2rem', paddingRight: '2.5rem' }}>
            <g className='grid-layer'>
                {gridLines.horizontal.map((el: { id: React.Key | null | undefined; x1: string | number | undefined; y1: string | number | undefined; x2: string | number | undefined; y2: string | number | undefined; }, index: number) => (
                    <line
                        ...
                        x2={el.x2}
                        y2={el.y2}
                        stroke={index == gridLines.horizontal.length - 1? 'black' : "#e0e0e0"   }
                        // strokeDasharray="4 4"
                        strokeWidth={index == gridLines.horizontal.length - 1? 2 : 1}
                    />
                ))}
            </g>
            ...
            <g className='bottom-layer'>
                <line
                    ...
                    x2={el.x2}
                    y2={el.y2}
                    stroke={index == gridLines.horizontal.length - 1?  : "#e0e0e0"   }
                    // strokeDasharray="4 4"
                    strokeWidth={index == gridLines.horizontal.length - 1? 2 : 1}
                />
            </g>
