...
const LineChart: React.FC<LineChartProps> = ({
    ...
    const [linePathLength, setDataPathLength] = useState(0);
    const dataPathRef = useRef<SVGPathElement | null>(null);
    ...
    const createFillPath = () => {
        ...
        pathData += ` L ${lastX} ${height}`;  // 마지막 점에서 아래로
        pathData += ` L ${firstX} ${height}`;  // 왼쪽 아래로
        pathData += ` Z`;  // 시작점으로 닫기
