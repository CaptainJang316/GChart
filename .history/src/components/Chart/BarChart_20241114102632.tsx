            ...
            <svg width='100%' height='100%' viewBox={`0 0 ${width} ${height + 30}`} style={{ border: '1px solid #ccc', padding: `${padding}px`}}>
                {               
                    ...
                    <g className='title-layer'>
                        ...
                        <StyledTitle 
                            ...
                            x={title.titleAlign == 'end'? '100%' : title.titleAlign == 'middle'? '50%' : axis?.yAxis?.axisLabel?.formatter != ''? -20 : -10}
                            y={20}
                        >
                            {title.text}
                        </StyledTitle>
                        {title.subTitle && (
                            <StyledSubTitle
                                ...
                                fill='gray'
                                x={title.titleAlign == 'start'? axis?.yAxis?.axisLabel?.formatter != ''? -20 : -10 : title.titleAlign == 'middle'? '50%' : '100%'}
                                y={47}
                ...
                <g className='axis-layer'>
                    {yAxis.ticks.map((tick) => (
                        <text
                            x={axis?.yAxis?.axisLabel?.formatter == ''? 5 : 0}
                            y={tick.position}
                            textAnchor="middle"
                            // fontSize="10"
                            fill="#333"
                        >
                        {tick.value}
                        {axis?.yAxis?.axisLabel?.formatter != '' && axis?.yAxis?.axisLabel?.formatter}
                        </text>
                    ))}
                </g>
