...
const LineChart: React.FC<ChartProps> = ({
    ...
    return (
        // svg 요소 안에, 차트를 그린다.
        <div style={{ display: 'inline-block', width: `${width}px`, height: `${height}px`, boxSizing: 'border-box' }}>
            <svg width='100%' height='100%' viewBox={`0 0 ${width} ${height + 20}`} style={{ border: '1px solid #ccc'}}>
