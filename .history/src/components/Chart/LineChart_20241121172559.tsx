                        ...
                        lineData.map((v, i) => (
                            fillArea && (
                                <StyledPathArea
                                    d={createAreaPath(v)}
                                    isVisible={isVisible}
                                    color={`${hoveredInfo.index !== null ? darkenColor(lineColors[i], 0.2)33 : lineColors[i]}33`}
                    ...
                    {lineData.map((_, i) => (
                        lineData[i].map((d, j) => (
                            <AnimatedCircle
                                ...
                                stroke="white"
                                strokeWidth="2"
                                delay={calculateAnimationDelay(j)}
                                onMouseOver={(e) => handleMouseMove(e, d, labels[j], j)}
                                onMouseOut={() => setHoveredInfo(prev => ({...prev, index: null}))}
                            />
                        ))
                    ))}
