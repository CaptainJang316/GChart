...
const BarChart: React.FC<Option> = ({
    ...
    return (
        ...
        <div style={{ display: 'inline-block', width: `${width}px`, height: `${height}px`}}>
            <svg width='100%' height='100%' viewBox={`0 0 ${width} ${height + 30}`} style={{ border: '1px solid #ccc', padding: '15px 20px 30px 16px'}}>
                {              
                    title? 
                ...
                <g className='chart-layer' style={{ marginLeft: '15px' }}>
                    {data.map((d, i) => {
