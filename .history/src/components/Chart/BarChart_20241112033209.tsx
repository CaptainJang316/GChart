...
const StyledRect = styled.rect<{ isHovered: boolean; color: string; hoverColor: string; finalHeight: number }>`
  fill: ${(props) => (props.isHovered ? props.hoverColor : props.color)};
  transition: fill 0.3s ease;
  animation: ${(props) => growHeight(props.finalHeight)} 0.8s ease-out; // 애니메이션 추가
