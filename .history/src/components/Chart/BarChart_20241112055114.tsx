...
const BarChart: React.FC<Option> = ({
    ...
    return (
        ...
        <div style={{ display: 'inline-block', width: `${width}px`, height: `${height}px`}}>
            <svg width='100%' height='100%' viewBox={`0 0 ${width} ${height + 30}`} onMouseMove={(e: React.MouseEvent<SVGAElement) => handleMouseMove()/>} style={{ border: '1px solid #ccc', padding: `${padding}px`}}>
                {               
                    title? 
