...
const LineChart: React.FC<LineChartProps> = ({
  ...
  const createPathForArea = (currLineValues: number[]) => {
    let areaData = '';
    if(lineStyle == "smooth") areaData = createSmoothLinePath(currLineValues);
    else areaData = createSolidLinePath(currLineValues);
