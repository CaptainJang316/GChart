        ...
        <div style={{ display: 'inline-block', width: `${width}px`, height: `${height}px`}}>
            <svg width='100%' height='100%' viewBox={`0 0 ${width} ${height + 30}`} style={{ border: '1px solid #ccc', padding: '1rem 1.5rem 1.5rem 1rem'}}>
                ...
                <g className='grid-layer'>
                    {gridLines.horizontal.map((el: { id: React.Key | null | undefined; x1: number | undefined; y1: string | number | undefined; x2: string | number | undefined; y2: string | number | undefined; }, index: number) => (
                        <line
                            key={el.id}
                            x1={el.x1}
                            y1={el.y1}
                    ...
                    {gridLines.vertical.map((el: { id: React.Key | null | undefined; x1: number | undefined; y1: number | undefined; x2: number | undefined; y2: number | undefined; }, index: number) => (
                        <line
                            key={el.id}
                            x1={el.x1}
                            y1={0}
